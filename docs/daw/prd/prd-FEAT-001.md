...
| FEAT-001d | Descubrir murales cercanos | prd-FEAT-001d.md | depends on b, c | done — PR [#4](https://github.com/martinbassi/aifirstbuilder-2026-mod5/pull/4) creado (borrador), pendiente de merge por el usuario |
