...
3. `frontend/angular.json`: `index` en `architect.build.configurations.development` sobreescribiendo
   `src/index.html` por `src/index.development.html` (R1; `fileReplacements` no es válido para
   `index.html` en el schema del builder de Angular — corregido en CODE).
